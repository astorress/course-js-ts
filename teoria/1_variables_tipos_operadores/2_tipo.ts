...
dato que se quiera
*/
let NumeroTipos: number = 10000;
let CadenaTipos: string = "19191";
let CualquieraTipos: any = 1111; // any es el tipo de dato que se asemeja al javascript
...
let NumeroTipos2: number | null | boolean = 1000;
