...
const { name: name2, lastName: lastName2, age: age2, _password: _password2 = "123456", post: { title: title2, content: content2, date: date2 }, } = userDestructuracion; // {nombreAntes: nombreDespues}
/*
const {
  name,
  lastName,
