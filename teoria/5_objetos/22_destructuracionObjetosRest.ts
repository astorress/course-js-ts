...
const userDestructuracionRest: UserDestructuracionRest = {
  name: "John",
  lastName: "Doe",
  age: 30,
  _password: "123456",
...
const {
  name: firstNameRest,
  lastName: lastNameRest,
  age: ageRestageRest,
  _password: _passwordRest = "123456",
} = userDestructuracionRest; // {nombreAntes: nombreDespues}
