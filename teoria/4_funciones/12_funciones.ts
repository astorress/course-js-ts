...
const aFuncion: number = 5;

function sumar(aFuncion: number, bFuncion: number) {
...
function sumar2(aFuncion2: number, bFuncion2: number): number {
...
function restar(aFuncion3: number, bFuncion3: number): number | undefined {
  if (typeof aFuncion3 != "number" || typeof bFuncion3 != "number") return;
  if (aFuncion3 < bFuncion3) return;
